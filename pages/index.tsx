    ...
    <div>
      ...
      <div className="flex overflow-hidden bg-white pt-16">
        <div
          ...
          className={`${
            openSideBar ? "hidden " : ""
          }fixed z-20 h-full top-0 left-0 pt-16 lg:flex flex-shrink-0 flex-col w-72 transition-all transform delay-150 duration-300`}
          aria-label="Sidebar"
        >
          <div
            className={`relative flex-1 flex flex-col min-h-0 h-full border-r border-gray-200 bg-white pt-0`}
          >
            <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
              <div className="flex-1 px-3 bg-white divide-y space-y-1">
                <ul className="space-y-2 pb-2">
                  ...
                  */}
                  <div className="text-blue-700">GESTÃO DE USUÁRIOS</div>

                  <li>
                    <a
                      // href="https://demo.themesberg.com/windster/"
                      href="#"
                      className="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-blue-100 group"
                    >
                      {/* <svg
                      ...
                      <FaUsers className="w-6 h-6 text-gray-500 group-hover:text-gray-900 transition duration-75" />
                      <span className="ml-3">Usuários</span>
                    </a>
                  </li>

                  <div className="text-blue-700">GESTÃO DE EMPRESAS</div>
                  ...
                  <li>
                    ...
                    >
                      ...
                      <FaBuilding className="w-6 h-6 text-gray-500 group-hover:text-gray-900 transition duration-75" />
                      <span className="ml-3">Empresas</span>
                    </a>
                  </li>

                  <div className="text-blue-700">GESTÃO DE DOCUMENTOS</div>
                  ...
                  <li>
                    ...
                    >
                      ...
                      <FaFolderOpen className="w-6 h-6 text-gray-500 group-hover:text-gray-900 transition duration-75" />
                      <span className="ml-3">Documentos</span>
                    </a>
                  </li>

                  <div className="text-blue-700">GESTOR FINANCEIRO</div>
                  ...
                  <li>
                    ...
                    >
                      ...
                      <FaMoneyBillAlt className="w-6 h-6 text-gray-500 group-hover:text-gray-900 transition duration-75" />
                  ...
                  <li>
                    ...
                    >
                      ...
                      <BiChevronUpCircle className="w-6 h-6 text-gray-500 group-hover:text-gray-900 transition duration-75" />
                      <span className="ml-3 flex-1 whitespace-nowrap">
                        Contas à Pagar
                      </span>
                      <span className="bg-gray-200 text-gray-800 ml-3 text-sm font-medium inline-flex items-center justify-center px-2 rounded-full">
                  ...
                  <li>
                    ...
                    >
                      ...
                      <BiChevronDownCircle className="w-6 h-6 text-gray-500 group-hover:text-gray-900 transition duration-75" />
                      <span className="ml-3 flex-1 whitespace-nowrap">
                        Contas à Receber
                      </span>
                    </a>
                  ...
                  <li>
                    <a
                      ...
                      className="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group cursor-pointer"
                    >
                      {/* <svg
                        className="w-6 h-6 text-gray-500 group-hover:text-gray-900 transition duration-75"
                        fill="currentColor"
                      ...
                      <FaBars className="w-6 h-6 text-gray-500 group-hover:text-gray-900 transition duration-75" />
                      <span className="ml-3 flex-1 whitespace-nowrap">
                        Cadastros
                      </span>
                    ...
                    {openSubmenu && (
                      <div style={{ padding: 10, marginLeft: "1rem" }}>
                        <li>
                          <a
                            href="https://demo.themesberg.com/windster-pro/kanban/"
                            target="_blank"
                  ...
                  <div className="text-blue-700">GESTOR DE TICKETS</div>
                  ...
                  <li>
                    ...
                    >
                      ...
                      <FaClipboardList className="w-6 h-6 text-gray-500 group-hover:text-gray-900 transition duration-75" />
                      <span className="ml-3 flex-1 whitespace-nowrap">
                  ...
                  <li>
                    ...
                    >
                      ...
                      <FiEdit className="w-6 h-6 text-gray-500 group-hover:text-gray-900 transition duration-75" />
                      <span className="ml-3 flex-1 whitespace-nowrap">
                        Tickets
                      </span>
                    </a>
                  ...
                  <div className="text-blue-700">GESTOR DE NOTAS FISCAIS</div>
                  ...
                  <li>
                    ...
                    >
                      ...
                      <BiSearch className="w-6 h-6 text-gray-500 group-hover:text-gray-900 transition duration-75" />
                      <span className="ml-3 flex-1 whitespace-nowrap">
                  ...
                  <li>
                    ...
                    >
                      ...
                      <BsReceipt className="w-6 h-6 text-gray-500 group-hover:text-gray-900 transition duration-75" />
                      <span className="ml-3 flex-1 whitespace-nowrap">
